...
pub use crate::system_allocator::{MmioType, AllocOptions, SystemAllocator, SystemAllocatorConfig};
...
pub enum Error {
    ...
    BadAlloc(Alloc),
    #[error("Alloc range already exists: {0:?}")]
    ExistingAddrRange(AddressRange),
