...
use winapi::um::winnt::{MEM_COMMIT, MEM_DECOMMIT, MEM_RELEASE, MEM_RESERVE, PAGE_EXECUTE_READWRITE};

use super::{mmap::Error, mmap::Result, MappedRegion, MemoryMapping, Protection, RawDescriptor};
use crate::descriptor::AsRawDescriptor;
use crate::platform::mem_type::*;
use crate::warn;
...
pub(crate) const PROT_EXECUTE: c_int = FILE_MAP_EXECUTE as c_int;
