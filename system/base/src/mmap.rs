...
impl Protection {
    /// Returns Protection allowing read/write/execute access.
    #[inline(always)]
    pub fn read_write_execute() -> Protection {
        Protection(PROT_READ | PROT_WRITE | PROT_EXEC)
    }
    /// Returns Protection allowing read/write access.
    #[inline(always)]
    pub fn read_exec() -> Protection {
...
pub struct MemoryMapping {
    ...
    // concern.
    pub _file_descriptor: Option<SafeDescriptor>,
}
